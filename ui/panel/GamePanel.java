...
public class GamePanel extends JPanel
{
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (level.isCompleted()) {
            ...
            g.drawString("Grade:" + level.getGrade(), 25, 30);
            char currentGrade = level.getGrade();
            System.out.println(level.getGrade());
           if(currentGrade<level.callHigh())
            	level.recordHigh(currentGrade);
            ...
            g.drawString("HighScore: " + level.callHigh(), 25, 40);
